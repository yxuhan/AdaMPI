'''
this code is adapt from the EdgeConnect repo (https://github.com/knazeri/edge-connect)
'''
...
class InpaintGenerator(BaseNetwork):
    def __init__(self, residual_blocks=8, init_weights=True, in_channels=4, out_channels=3):
